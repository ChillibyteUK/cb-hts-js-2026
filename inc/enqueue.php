 ...
 * @return void
 */
function lc_js_skeleton_enqueue_styles() {
...
add_action( 'wp_enqueue_scripts', 'lc_js_skeleton_enqueue_styles' );
 ...
 * @return void
 */
function lc_js_skeleton_enqueue_scripts() {
...
add_action( 'wp_enqueue_scripts', 'lc_js_skeleton_enqueue_scripts' );
