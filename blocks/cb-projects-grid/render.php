 ...
 *
 * Fixed 5-card mosaic of the most recent projects (menu order, then date) —
 * the first card is a hero tile (span 4x2), the fourth is wide (span 4x1),
 * the rest are standard (span 2x1). A card is only a link when its post has
 * body content, otherwise it renders as a non-interactive tile — same
 * pattern as CB Applications Grid.
 *
